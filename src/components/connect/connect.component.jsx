  ...
  return (
     ...
     <div className="first-connect">
       ...
       <div className="right-section">
        ...
        <div className="point-text">
            <img src={Tick} alt="" />
            <div className="point-para">We connect our customers with the best.</div>
        </div>
        <div className="point-text">
            <img src={Tick} alt="" />
            <div className="point-para">Advisor success customer launch party.</div>
        </div>
        <div className="point-text">
            <img src={Tick} alt="" />
        ...
        <div className="btn-section">
            <Button color="#FFF" bgcolor="#0A2640">Start now</Button>
        </div>
    ...
    <div className="left-sec">
     ...
     <div className="key-point">
        <img src={Feather} alt="" />
        <div className="key-text">We connect our customers with the best.</div>
     </div>

     <div className="key-point1">
        <img src={Eye} alt="" />
        <div className="key-text1">Advisor success customer launch party.</div>
     </div>
